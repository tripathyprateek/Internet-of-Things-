      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (strlen(buffer) == 0) {
            ...
            client.println("<h1 align=center><font color=\"blue\">Welcome to the CC3200 WiFi Web Server</font></h1>");
            ...
            client.print("GREEN LED <button onclick=\"location.href='/GH'\">HIGH</button>");
            client.println(" <button onclick=\"location.href='/GL'\">LOW</button><br>");

            client.print("BLUE LED <button onclick=\"location.href='/BH'\">HIGH</button>");
            client.println(" <button onclick=\"location.href='/BL'\">LOW</button><br>");
